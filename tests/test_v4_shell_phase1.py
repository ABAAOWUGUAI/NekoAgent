...
class V4ShellPhase1Tests(unittest.TestCase):
    ...
    def test_shell_has_single_transition_command_navigation_and_no_data_transport(self):
        ...
        self.assertIn('internalV4Transition', source)
        self.assertIn('pendingExplicitRouteId', source)
        self.assertIn('pendingExplicitRouteId = route.id', source)
        self.assertIn('pendingExplicitRouteId = \'\'', source)
